...
namespace KaraokeList
{
    public class AlphaKeyGroup<T> : List<T>
    {
        ...
        private static void AddMoreItems(ObservableCollection<AlphaKeyGroup<T>> list, IEnumerable<T> items, SortedLocaleGrouping slg, GetKeyDelegate getKey)
        {
        ...
        public static void AddMoreItemsSorted(ObservableCollection<AlphaKeyGroup<T>> list, IEnumerable<T> items, CultureInfo ci, GetKeyDelegate getKey)
        {
            SortedLocaleGrouping slg = new SortedLocaleGrouping(ci);
            AddMoreItems(list, items, slg, getKey);
        }
