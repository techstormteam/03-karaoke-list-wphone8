...
namespace KaraokeList
{
    public partial class App : Application
    {
        ...
        public static SQLiteConnection DbConnectionProperty
        {
            get
            {
        ...
        private static ViewModelSong viewModelSong = null;
        public static ViewModelSong ViewModelSongProperty
        {
            get
            {
                if (viewModelSong == null)
                {
        ...
        private void loadData()
        {
            ...
            if (!App.ViewModelSongProperty.IsDataLoaded)
            {
                loadViewModels();
            }
        }

        private async void copyDatabaseFileIfNewer()
        {
        ...
        {
            copyDatabaseFileIfNewer();



            // Check for ask review application.
